...
class Workshop extends Model
{
    ...
    {
        return $this->hasOne(WorkShopDetail::class, 'workshop_uuid', 'uuid');
    }
    public function order()
    {
        return $this->hasMany(WorkShopOrder::class, 'workshop_uuid', 'uuid');
    }
    public function session()
    {
        return $this->hasOne(WorkShopSession::class, 'workshop_uuid', 'uuid');
    }
    public function featuredCourse()
    {
        return $this->belongsTo(FeaturedWorkShop::class, 'workshop_uuid', 'uuid');
    }
}
